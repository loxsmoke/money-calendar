...
public sealed record ReleaseInfo(string Version, DateTimeOffset PublishedAt, string? DownloadUrl, long DownloadSize);
...
public static class UpdateCheck
{
    ...
    /// <summary>The release asset the workflow attaches, and what a download link points at.</summary>
